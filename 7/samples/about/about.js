...
'		  <td class="tipl">One single function for both <b>Item Validation </b> and <b>Presentation of Validation Errors</b> (in Items, Section, Popup)</td>' + 
'     <td class="tipc"><input type="button"  class="browserAllSmall" title="' + JSU_TITLE_BROWSER_ALL + '"/> </td> ' +
...
function initSampleCmn(){
	...
	try{
		...
		jslog (JSLOG_DEBUG,fn + "JSU FREE=" + bJsuFree);
		// show Label with Limitition only for FREE JSU
		elementShowById ('sample_limit', bJsuFree,"block");
